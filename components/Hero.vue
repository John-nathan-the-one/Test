<template>
  <!-- Hero section start -->
  <div class="bg-black">
    <section class="mx-auto max-w-1440 grid grid-cols-2 max-xl:grid-cols-1 max-xl:pl-7 pl-14 items-center relative overflow-hidden">
        ...
        <div class="overflow-visible mx-auto hero-image">
          ...
          <img src="../assets/images/NewNameContent.png" class="w-10/12 max-[1280px]:mx-auto min-[900px]:max-[1280px]:w-8/12  mb-2 ghost"/>
        </div>
...
<style scoped>
    ...
    .circle-shadow{
        ...
        background-color: rgba(133, 62, 62, 0);
        transition: 3s ease;
        bottom: -240px;
        right: -192px;
    }
