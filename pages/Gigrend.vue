<template>
    ...
    <!-- Hero section end -->
      ...
      <!-- Categories Section starts -->
          ...
          <!-- 1st Card starts -->
      <div class="w-fit mx-auto text-center sora -mt-16 mb-28 max-lg:hidden">
      ...
      <!-- Categories Section starts -->
          ...
          <!-- 1st Card starts -->
      <div class="w-fit mx-auto text-center sora -mt-16 mb-28 hidden min-[831px]:max-[1023px]:block">
        <p class="text-4xl font-semibold mb-6 ">Popular Categories</p>
...
<!-- Categories Section starts -->
          ...
          <!-- 1st Card starts -->
          <div class="w-fit mx-auto text-center sora mb-28 -mt-16 hidden min-[631px]:max-[830px]:block">
        <p class="text-4xl font-semibold mb-6 ">Popular Categories</p>
      ...
      <!-- Categories Section starts -->
          ...
          <!-- 1st Card starts -->
          <div class="w-fit mx-auto text-center sora -mt-16 mb-28 hidden min-[501px]:max-[630px]:block">
        <p class="text-4xl font-semibold mb-6 ">Popular Categories</p>
      ...
      <!-- Categories Section starts -->
          ...
          <!-- 1st Card starts -->
          <div class="w-fit mx-auto text-center sora -mt-16 hidden min-[0px]:max-[500px]:block mb-28">
        <p class="text-4xl font-semibold mb-6 ">Popular Categories</p>
  ...
  <style scoped>
      ...
      .responsiveGrid {
        display: grid;
        grid-template-columns: repeat(auto-fill, minmax(fit-content, max-content));
        grid-gap: 5px;
      }
      .categories{
